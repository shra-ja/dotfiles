# Generated by Powerlevel10k configuration wizard on 2022-09-03 at 18:44 BST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      local branch_color='%141F' # branch name colour
  ...
  typeset -g POWERLEVEL9K_ASDF_YARN_FOREGROUND=248
  # typeset -g POWERLEVEL9K_ASDF_YARN_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_ASDF_YARN_SHOW_ON_UPGLOB='package.json|.yarnrc.yml|yarn.lock'
  ...
  typeset -g POWERLEVEL9K_ASDF_GRADLE_FOREGROUND=28
  ...
  # typeset -g POWERLEVEL9K_ASDF_JAVA_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_ASDF_JAVA_SHOW_ON_UPGLOB='*.java|*.scala|*.sbt'

  # SBT version from asdf.
  typeset -g POWERLEVEL9K_ASDF_SBT_FOREGROUND=172
  # typeset -g POWERLEVEL9K_ASDF_SBT_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_ASDF_SBT_SHOW_ON_UPGLOB='*.scala|*.sbt'
